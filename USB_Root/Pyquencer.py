...
def Set_Text():
    Set_1_1 = font1.render("BPM", True, (47, 75, 25))
    Set_1_2 = font1.render("Fadein Time", True, (47, 75, 25))
    Set_1_3 = font1.render("Fadeout Time", True, (47, 75, 25))
    Set_1_4 = font1.render("Steps", True, (47, 75, 25))
    Set_1_5 = font1.render("Two Simultanious Tracks", True, (47, 75, 25))
    Set_1_6 = font1.render("Track Offset", True, (47, 75, 25))
    ...
    Set_2_1 = font1.render("{}".format(set_list[0]), True, (47, 75, 25))
    window.blit(Set_2_1, (set_pos_x[1] + set_x_offset, set_pos_y[0] + set_y_offset))
    Set_2_2 = font1.render("{}s".format(set_list[1] / 1000), True, (47, 75, 25))
    window.blit(Set_2_2, (set_pos_x[1] + set_x_offset, set_pos_y[1] + set_y_offset))
    Set_2_3 = font1.render("{}s".format(set_list[2] / 1000), True, (47, 75, 25))
    window.blit(Set_2_3, (set_pos_x[1] + set_x_offset, set_pos_y[2] + set_y_offset))
    Set_2_4 = font1.render("{}".format(set_list[3]), True, (47, 75, 25))
    window.blit(Set_2_4, (set_pos_x[1] + set_x_offset, set_pos_y[3] + set_y_offset))
    if set_list[4] == True:
        Set_2_5 = font1.render("ON", True, (47, 75, 25))
        Set_2_6 = font1.render("{}%".format(set_list[5]), True, (47, 75, 25))
        window.blit(Set_2_6, (set_pos_x[1] + set_x_offset, set_pos_y[5] + set_y_offset))
    else:
        Set_2_5 = font1.render("OFF", True, (47, 75, 25))
...
def Seq_Choice_Up():
    ...
    if box_pos[1] == 2:
        ...
        Boxes[box_pos[1]][box_pos[0] + 1] = font1.render(Octs[(AllSteps_Main[box_pos[0]])[box_pos[1]]], True, (47, 75, 25))
    if box_pos[1] == 3:
...
def Creat_Boxes():
    Box_0_1 = font1.render("Type", True, (47, 75, 25))
    Box_0_2 = font1.render(Types[(AllSteps_Main[0])[0]], True, (47, 75, 25))
    Box_0_3 = font1.render(Types[(AllSteps_Main[1])[0]], True, (47, 75, 25))
    Box_0_4 = font1.render(Types[(AllSteps_Main[2])[0]], True, (47, 75, 25))
    Box_0_5 = font1.render(Types[(AllSteps_Main[3])[0]], True, (47, 75, 25))
    Box_0_6 = font1.render(Types[(AllSteps_Main[4])[0]], True, (47, 75, 25))
    Box_0_7 = font1.render(Types[(AllSteps_Main[5])[0]], True, (47, 75, 25))
    Box_0_8 = font1.render(Types[(AllSteps_Main[6])[0]], True, (47, 75, 25))
    Box_0_9 = font1.render(Types[(AllSteps_Main[7])[0]], True, (47, 75, 25))
    Box_0_10 = font1.render(Types[(AllSteps_Main[8])[0]], True, (47, 75, 25))
    Box_0_11 = font1.render(Types[(AllSteps_Main[9])[0]], True, (47, 75, 25))
    Box_0_12 = font1.render(Types[(AllSteps_Main[10])[0]], True, (47, 75, 25))
    Box_0_13 = font1.render(Types[(AllSteps_Main[11])[0]], True, (47, 75, 25))
    Box_0_14 = font1.render(Types[(AllSteps_Main[12])[0]], True, (47, 75, 25))
    Box_0_15 = font1.render(Types[(AllSteps_Main[13])[0]], True, (47, 75, 25))
    Box_0_16 = font1.render(Types[(AllSteps_Main[14])[0]], True, (47, 75, 25))
    Box_0_17 = font1.render(Types[(AllSteps_Main[15])[0]], True, (47, 75, 25))
    # _
    Box_1_1 = font1.render("Bank", True, (47, 75, 25))
    ...
    if ((AllSteps_Main[0])[0]) == 3:
        Banks = Banks_F
    Box_1_2 = font1.render(Banks[(AllSteps_Main[0])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[1])[0]) == 3:
        Banks = Banks_F
    Box_1_3 = font1.render(Banks[(AllSteps_Main[1])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[2])[0]) == 3:
        Banks = Banks_F
    Box_1_4 = font1.render(Banks[(AllSteps_Main[2])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[3])[0]) == 3:
        Banks = Banks_F
    Box_1_5 = font1.render(Banks[(AllSteps_Main[3])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[4])[0]) == 3:
        Banks = Banks_F
    Box_1_6 = font1.render(Banks[(AllSteps_Main[4])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[5])[0]) == 3:
        Banks = Banks_F
    Box_1_7 = font1.render(Banks[(AllSteps_Main[5])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[6])[0]) == 3:
        Banks = Banks_F
    Box_1_8 = font1.render(Banks[(AllSteps_Main[6])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[7])[0]) == 3:
        Banks = Banks_F
    Box_1_9 = font1.render(Banks[(AllSteps_Main[7])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[8])[0]) == 3:
        Banks = Banks_F
    Box_1_10 = font1.render(Banks[(AllSteps_Main[8])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[9])[0]) == 3:
        Banks = Banks_F
    Box_1_11 = font1.render(Banks[(AllSteps_Main[9])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[10])[0]) == 3:
        Banks = Banks_F
    Box_1_12 = font1.render(Banks[(AllSteps_Main[10])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[11])[0]) == 3:
        Banks = Banks_F
    Box_1_13 = font1.render(Banks[(AllSteps_Main[11])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[12])[0]) == 3:
        Banks = Banks_F
    Box_1_14 = font1.render(Banks[(AllSteps_Main[12])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[13])[0]) == 3:
        Banks = Banks_F
    Box_1_15 = font1.render(Banks[(AllSteps_Main[13])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[14])[0]) == 3:
        Banks = Banks_F
    Box_1_16 = font1.render(Banks[(AllSteps_Main[14])[1]], True, (47, 75, 25))
    ...
    if ((AllSteps_Main[15])[0]) == 3:
        Banks = Banks_F
    Box_1_17 = font1.render(Banks[(AllSteps_Main[15])[1]], True, (47, 75, 25))
    # _
    Box_2_1 = font1.render("Oct", True, (47, 75, 25))
    Box_2_2 = font1.render(Octs[(AllSteps_Main[0])[2]], True, (47, 75, 25))
    Box_2_3 = font1.render(Octs[(AllSteps_Main[1])[2]], True, (47, 75, 25))
    Box_2_4 = font1.render(Octs[(AllSteps_Main[2])[2]], True, (47, 75, 25))
    Box_2_5 = font1.render(Octs[(AllSteps_Main[3])[2]], True, (47, 75, 25))
    Box_2_6 = font1.render(Octs[(AllSteps_Main[4])[2]], True, (47, 75, 25))
    Box_2_7 = font1.render(Octs[(AllSteps_Main[5])[2]], True, (47, 75, 25))
    Box_2_8 = font1.render(Octs[(AllSteps_Main[6])[2]], True, (47, 75, 25))
    Box_2_9 = font1.render(Octs[(AllSteps_Main[7])[2]], True, (47, 75, 25))
    Box_2_10 = font1.render(Octs[(AllSteps_Main[8])[2]], True, (47, 75, 25))
    Box_2_11 = font1.render(Octs[(AllSteps_Main[9])[2]], True, (47, 75, 25))
    Box_2_12 = font1.render(Octs[(AllSteps_Main[10])[2]], True, (47, 75, 25))
    Box_2_13 = font1.render(Octs[(AllSteps_Main[11])[2]], True, (47, 75, 25))
    Box_2_14 = font1.render(Octs[(AllSteps_Main[12])[2]], True, (47, 75, 25))
    Box_2_15 = font1.render(Octs[(AllSteps_Main[13])[2]], True, (47, 75, 25))
    Box_2_16 = font1.render(Octs[(AllSteps_Main[14])[2]], True, (47, 75, 25))
    Box_2_17 = font1.render(Octs[(AllSteps_Main[15])[2]], True, (47, 75, 25))

    # _
    Box_3_1 = font1.render("Note 1", True, (47, 75, 25))
    Box_3_2 = font1.render(Notes[(AllSteps_Main[0])[3]], True, (47, 75, 25))
    Box_3_3 = font1.render(Notes[(AllSteps_Main[1])[3]], True, (47, 75, 25))
    Box_3_4 = font1.render(Notes[(AllSteps_Main[2])[3]], True, (47, 75, 25))
    Box_3_5 = font1.render(Notes[(AllSteps_Main[3])[3]], True, (47, 75, 25))
    Box_3_6 = font1.render(Notes[(AllSteps_Main[4])[3]], True, (47, 75, 25))
    Box_3_7 = font1.render(Notes[(AllSteps_Main[5])[3]], True, (47, 75, 25))
    Box_3_8 = font1.render(Notes[(AllSteps_Main[6])[3]], True, (47, 75, 25))
    Box_3_9 = font1.render(Notes[(AllSteps_Main[7])[3]], True, (47, 75, 25))
    Box_3_10 = font1.render(Notes[(AllSteps_Main[8])[3]], True, (47, 75, 25))
    Box_3_11 = font1.render(Notes[(AllSteps_Main[9])[3]], True, (47, 75, 25))
    Box_3_12 = font1.render(Notes[(AllSteps_Main[10])[3]], True, (47, 75, 25))
    Box_3_13 = font1.render(Notes[(AllSteps_Main[11])[3]], True, (47, 75, 25))
    Box_3_14 = font1.render(Notes[(AllSteps_Main[12])[3]], True, (47, 75, 25))
    Box_3_15 = font1.render(Notes[(AllSteps_Main[13])[3]], True, (47, 75, 25))
    Box_3_16 = font1.render(Notes[(AllSteps_Main[14])[3]], True, (47, 75, 25))
    Box_3_17 = font1.render(Notes[(AllSteps_Main[15])[3]], True, (47, 75, 25))

    Box_4_1 = font1.render("Note 2", True, (47, 75, 25))
    Box_4_2 = font1.render(Notes[(AllSteps_Main[0])[4]], True, (47, 75, 25))
    Box_4_3 = font1.render(Notes[(AllSteps_Main[1])[4]], True, (47, 75, 25))
    Box_4_4 = font1.render(Notes[(AllSteps_Main[2])[4]], True, (47, 75, 25))
    Box_4_5 = font1.render(Notes[(AllSteps_Main[3])[4]], True, (47, 75, 25))
    Box_4_6 = font1.render(Notes[(AllSteps_Main[4])[4]], True, (47, 75, 25))
    Box_4_7 = font1.render(Notes[(AllSteps_Main[5])[4]], True, (47, 75, 25))
    Box_4_8 = font1.render(Notes[(AllSteps_Main[6])[4]], True, (47, 75, 25))
    Box_4_9 = font1.render(Notes[(AllSteps_Main[7])[4]], True, (47, 75, 25))
    Box_4_10 = font1.render(Notes[(AllSteps_Main[8])[4]], True, (47, 75, 25))
    Box_4_11 = font1.render(Notes[(AllSteps_Main[9])[4]], True, (47, 75, 25))
    Box_4_12 = font1.render(Notes[(AllSteps_Main[10])[4]], True, (47, 75, 25))
    Box_4_13 = font1.render(Notes[(AllSteps_Main[11])[4]], True, (47, 75, 25))
    Box_4_14 = font1.render(Notes[(AllSteps_Main[12])[4]], True, (47, 75, 25))
    Box_4_15 = font1.render(Notes[(AllSteps_Main[13])[4]], True, (47, 75, 25))
    Box_4_16 = font1.render(Notes[(AllSteps_Main[14])[4]], True, (47, 75, 25))
    Box_4_17 = font1.render(Notes[(AllSteps_Main[15])[4]], True, (47, 75, 25))

    Box_5_1 = font1.render("Note 3", True, (47, 75, 25))
    Box_5_2 = font1.render(Notes[(AllSteps_Main[0])[5]], True, (47, 75, 25))
    Box_5_3 = font1.render(Notes[(AllSteps_Main[1])[5]], True, (47, 75, 25))
    Box_5_4 = font1.render(Notes[(AllSteps_Main[2])[5]], True, (47, 75, 25))
    Box_5_5 = font1.render(Notes[(AllSteps_Main[3])[5]], True, (47, 75, 25))
    Box_5_6 = font1.render(Notes[(AllSteps_Main[4])[5]], True, (47, 75, 25))
    Box_5_7 = font1.render(Notes[(AllSteps_Main[5])[5]], True, (47, 75, 25))
    Box_5_8 = font1.render(Notes[(AllSteps_Main[6])[5]], True, (47, 75, 25))
    Box_5_9 = font1.render(Notes[(AllSteps_Main[7])[5]], True, (47, 75, 25))
    Box_5_10 = font1.render(Notes[(AllSteps_Main[8])[5]], True, (47, 75, 25))
    Box_5_11 = font1.render(Notes[(AllSteps_Main[9])[5]], True, (47, 75, 25))
    Box_5_12 = font1.render(Notes[(AllSteps_Main[10])[5]], True, (47, 75, 25))
    Box_5_13 = font1.render(Notes[(AllSteps_Main[11])[5]], True, (47, 75, 25))
    Box_5_14 = font1.render(Notes[(AllSteps_Main[12])[5]], True, (47, 75, 25))
    Box_5_15 = font1.render(Notes[(AllSteps_Main[13])[5]], True, (47, 75, 25))
    Box_5_16 = font1.render(Notes[(AllSteps_Main[14])[5]], True, (47, 75, 25))
    Box_5_17 = font1.render(Notes[(AllSteps_Main[15])[5]], True, (47, 75, 25))
...
def Creat_Floppy():
    Floppy_1 = font3.render("1", True, (47, 75, 25))
    Floppy_2 = font3.render("2", True, (47, 75, 25))
    Floppy_3 = font3.render("3", True, (47, 75, 25))
    Floppy_4 = font3.render("4", True, (47, 75, 25))
    Floppy_5 = font3.render("5", True, (47, 75, 25))
    Floppy_6 = font3.render("6", True, (47, 75, 25))
    Floppy_7 = font3.render("7", True, (47, 75, 25))
    Floppy_8 = font3.render("8", True, (47, 75, 25))
    Floppy_9 = font3.render("9", True, (47, 75, 25))
    Floppy_10 = font3.render("10", True, (47, 75, 25))
    Floppy_11 = font3.render("11", True, (47, 75, 25))
    Floppy_12 = font3.render("12", True, (47, 75, 25))
...
def Vol_up():
    ...
    if keys[pygame.K_RIGHT] and keys[pygame.K_a] or Right.is_pressed and B.is_pressed:
        ...
        Vol = font2.render("{}".format(vol), True, (47, 75, 25))
